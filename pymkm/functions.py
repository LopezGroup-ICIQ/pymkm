...
from pymkm.constants import K_B, K_BU, H, R
from pymkm.rm_parser import stoic_backward, stoic_forward


def kinetic_coeff(
    NR, dg_reaction, dg_barrier, temperature, reaction_type, m, a_site=1e-19
):
    """
